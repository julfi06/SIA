...
class SeederAkun3 extends Seeder
{
    public function run()
    {
        $data = [
            ...
            [
            'kode_akun3'    => 5107,
            'nama_akun3'    => 'Beban Penyusutan Perlat Kantor',
            'kode_akun1'    => '5',
            'kode_akun2'    => '51',
            ],
            [
        ...
        // Using Query Builder
        // $this->db->table('akun1')->insert($data);
        $this->db->table('akun3')->InsertBatch($data);
    }
}
