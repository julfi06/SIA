...
<title>SIA-OWITT &mdash; Neraca Lajur</title>
<?= $this->endSection() ?>
                ...
                <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="submit" class="btn btn-success" formtarget="_blank" formaction="neracalajur/neracalajurpdf" value="Cetak PDF"></input>
                        </div>
                    </div>
                </form>
            </div>
