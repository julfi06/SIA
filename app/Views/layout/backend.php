    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <!-- <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="<?=base_url()?>/template/assets/img/avatar/avatar-5.png" class="rounded-circle mr-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?=site_url('home') ?>"><img alt="image" src="<?=base_url()?>/template/assets/img/avatar/logo-owit.jpg" class="rounded-circle mr-1" height="120" width="120"/></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?=site_url('home') ?>"><img alt="image" src="<?=base_url()?>/template/assets/img/avatar/logo-owit.jpg" class="rounded-circle mr-1" height="50" width="50"/></a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <!-- <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
              <a href="https://getstisla.com/docs" class="btn btn-primary btn-lg btn-block btn-icon-split">
                <i class="fas fa-rocket"></i> SIA OWITT
              </a>
            </div> -->
        </aside>
      </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2023 <div class="bullet"></div> Design By <a href="">Julfi Daffa Agung</a>
        </div>
