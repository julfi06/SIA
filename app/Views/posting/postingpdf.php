                    ...
                    <table border="0.1px" class="table tab-bordered">
                        <thead>
                            <tr>
                                ...
                                <td class="text-center" rowspan="2" width="200px">Keterangan</td>
                                <td class="text-center" rowspan="2" width="50px">Ref</td>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dttransaksi as $key => $value) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="aturtengah" width="200px"><?= $value->ketjurnal ?></td>
