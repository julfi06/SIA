...
<title>SIA-OWITT &mdash; Posting</title>
<?= $this->endSection() ?>
                ...
                <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="submit" class="btn btn-success" formtarget="_blank" formaction="posting/postingpdf" value="Cetak PDF"></input>
                        </div>
                    </div>
                </form>
            </div>
