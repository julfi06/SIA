...
<title>SIA-OWITT &mdash; Neraca Saldo</title>
<?= $this->endSection() ?>
                ...
                <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="submit" class="btn btn-success" formtarget="_blank" formaction="neracasaldo/neracasaldopdf" value="Cetak PDF"></input>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-striped table-md">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dttransaksi as $key => $value) : ?>
                                ...
                                <tr>
                                    <td class="text-center"><?= $value->kode_akun3 ?></td>
