...
<title>SIA-OWITT &mdash; Jurnal Umum</title>
<?= $this->endSection() ?>
                ...
                <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="submit" class="btn btn-success" formtarget="_blank" formaction="jurnalumum/cetakjupdf" value="Cetak PDF"></input>
                        </div>
                    </div>
                </form>
            </div>
