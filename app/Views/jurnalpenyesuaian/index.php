...
<title>SIA-OWITT &mdash; Jurnal Penyesuaian</title>
<?= $this->endSection() ?>
...
<section class="section">
          <div class="section-header">
            <h6>LAPORAN JURNAL PENYESUAIAN</h6>
          </div>
                ...
                <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="submit" class="btn btn-success" formtarget="_blank" formaction="jurnalpenyesuaian/cetak_jppdf" value="Cetak PDF"></input>
                        </div>
                    </div>
                </form>
            </div>
