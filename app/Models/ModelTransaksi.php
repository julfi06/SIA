...
class ModelTransaksi extends Model
{
    ...
    public function noKwitansi()
    {
        ...
        $number = $db->table('tbl_transaksi')->select('RIGHT(tbl_transaksi.kwitansi,4) as kwitansi', FALSE)
...
public function get_jpenyesuaian($tglawal, $tglakhir)
{
    $sql = $this->db->table('tbl_nilaipenyesuaian')
        ...
        ->join('akun3', 'akun3.kode_akun3=tbl_nilaipenyesuaian.kode_akun3')
        ->selectSum('debit', 'jumdebit')
        ->selectSum('kredit', 'jumkredit')
        ->select('akun3.kode_akun3, akun3.nama_akun3, tbl_penyesuaian.tanggal')
        ->groupBy('akun3.kode_akun3');
...
public function get_neracasaldo($tglawal, $tglakhir)
{
    $sql = $this->db->table('tbl_nilai')
        ...
        ->selectSum('debit', 'jumdebit')
        ->selectSum('kredit', 'jumkredit')
        ->select('akun3.kode_akun3, akun3.nama_akun3, tbl_transaksi.tanggal, debit, kredit')
        ->groupBy('akun3.kode_akun3');
...
public function get_neracalajur($tglawal, $tglakhir)
{
    ...
    $sql = $this->db->query("SELECT * FROM(
        ...
        FROM tbl_nilai as tb1
            ...
            join akun3 as tbak on tb1.kode_akun3 = tbak.kode_akun3
            " . $where1 . "
        ...
        FROM tbl_nilai as tb1
            ...
            join akun3 as tbak on tb2.kode_akun3 = tbak.kode_akun3
...
public function get_perubahanmodal($tglawal, $tglakhir)
{
    $where1 = '';
    $where2 = '';
