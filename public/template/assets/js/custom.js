...
function Barisbaru() {
    ...
    var Baris = '<tr>';
        ...
        Baris += '</td>';
        Baris += '<td>';
        Baris += '<input type="number" name="debit[]" class="form-control debit" placeholder="Debit..." required> </input>';
        Baris += '</td>';
        Baris += '<td>';
        Baris += '<input type="number" name="kredit[]" class="form-control kredit" placeholder="Kredit..." required> </input>';
        Baris += '</td>';
        Baris += '<td>';
        Baris += '<select class="form-control" name="id_status[]" id="id_status' + Nomor + '" required> </select>';
        Baris += '</td>';
        Baris += '<td class="text-center">';
        Baris += '<a class="btn btn-sm btn-danger" title="Hapus Baris" id="HapusBaris"><i class="fas fa-times"></i> </a>';
        Baris += '</td>';
        Baris += '</tr>';
